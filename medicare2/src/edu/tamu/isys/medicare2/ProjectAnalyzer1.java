...
public class ProjectAnalyzer1 {			//project variables being declared
			...
			private void parseProjectDetails(String ProjectData) throws ParseException{
				...
				String[] ProjectParts = ProjectData.split(";"); //parsing data and populating corresponding system variables
			...
			public String getDisease() {		//function to return disease
				return Disease;	
			}
			public String Hospital_Id() {		//function to return hospital id
				return Hospital_Id;
			}
			public String getHospital_Name() {	//function to return hospital name
				return Hospital_Name;
			}
			public String getHospital_Street_Address() {	//function to return street address
				return Hospital_Street_Address;
			}
			public String getHospital_City() {	//function to return city
				return Hospital_City;
			}
			public String getHospital_State() {	//function to return state
				return Hospital_State;
			}
			public String getHospital_Zip() {	//function to return zip code
				return Hospital_Zip;
			}
			public String getHospital_County() {	//function to return county
				return Hospital_County;
			}
			public String getTotal_Cured() {	//function to return total discharged
				return Total_Cured;
			}
			public String getAverage_Covered_Charges() {	//function to return avg covered charges
				return Average_Covered_Charges;
			}
			public String getAverage_Total_Payments() {		//function to return avg total payments
				return Average_Total_Payments;
			}
			public String getAverage_Medicare_Payments() {	//function to return avg medicare payments
